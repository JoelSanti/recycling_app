...
class LabelInfoDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var label = imageLabels != null && imageLabels!.isNotEmpty ? imageLabels!.first : null;
    ...
    switch (type) {
      ...
      case 'Residuos Orgánicos Aprovechables':
        backgroundColor = Colors.green[100] ?? Colors.green; // Default to Colors.green if Colors.green[100] is null
        break;
      case 'Residuos No Aprovechables':
        backgroundColor = Colors.red[100] ?? Colors.red; // Default to Colors.red if Colors.red[100] is null
        break;
      default:
                  ...
                  RichText(
                    text: TextSpan(
                      children: <TextSpan>[
                        ...
                        TextSpan(
                          text: 'Son aquellos residuos que no pueden ser reciclados ni compostados debido a su composición o contaminación, y generalmente se destinan a rellenos sanitarios o incineración. Incluyen productos como pañales desechables, papel higiénico usado, toallas sanitarias, colillas de cigarrillos, envases contaminados con sustancias peligrosas, y algunos tipos de plásticos no reciclables',
                          style: TextStyle(color: Color(kDarkBlue.value)),
                        ),
                      ],
                    ),
